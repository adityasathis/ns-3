...
for ratio in trafficRatios:
  for capc in capc_configs:
    file_path = f'nru-csv/change{variation}-gnb6-ap0-ut10-ratio{ratio.replace(':', '')}-numerology0-bandwidth20-capc{capc}-simtime1.csv'
...
x = np.arange(len(trafficRatios))  # the label locations
